 ...
 */
var ContinuousActuator = React.createClass({displayName: "ContinuousActuator",
    render: function() {
        return(
            React.createElement("div", {className: "continuousActuator"}, 
                React.createElement("p", null, "Slider")
            )
        );
    }
});
 ...
 */
var BinaryActuator = React.createClass({displayName: "BinaryActuator",
    ...
    render: function() {
        ...
        return(
            React.createElement("div", {className: "binaryActuator"}, 
